...
var EquipDescription = map[string]map[string]DescriptionItem{
	...
	_const.RU: {
		...
		"energy_charging_speed_1":        {Name: "Вспомогательный ториевый реактор", Description: "<p>Устройство поддержки энергетической разновидности. Позволяет корпусу быстрее и эффективнее заряжать аккумулятор от главного ториевого реактора.</p>"},
