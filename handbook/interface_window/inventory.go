...
var Inventory = map[string]map[string]string{
	...
	"tip_8": {
        ...
        <div>► Для модификаторов: 9-21% за смерть.</div>
		<div>► Чем выше износ, тем меньше ресурсов при разборе.<br><br></div>
        ...
        <div>► For modifiers: 9-21% per death.</div>
