...
var WeaponDescription = map[string]map[string]DescriptionItem{
	...
	_const.ZhCN: {
		...
		"explores_weapon_2": {Name: "菲拉斯", Description: "<p>廉价、耐用、大规模生产——这是对Explores光束发射器系列“菲拉斯”的最佳诠释。其高精度切割光束是该产品的核心优势。</p>"},
		...
		"reverses_weapon_2": {Name: "电涌", Description: "<p>Reverses标准军用双联导弹发射器。中等射速与载弹量通过卓越的转向速度弥补，展现战术灵活性。</p>"},
		"reverses_weapon_3": {Name: "电涌-Mk2", Description: "<p>“电涌-Mk2”继承前代设计理念并进行全面升级。钟情于观赏爆炸艺术的玩家将获得双重享受。</p>"},
		...
		"explores_weapon_6": {Name: "瓦解者", Description: "<p>Explores特化激光武器，通过持续照射产生递增伤害，实现基于热流加速原理的独特杀伤模式。</p>"},
	},
}
