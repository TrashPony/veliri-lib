...
func (coor *Coordinate) ApplyCorporationPolicy(policy string, unions, rivals []string, owner string) {
	...
	coor.Access = true
	coor.AccessInvers = policy == _const.CorporationPolicyExceptUnions || policy == _const.CorporationPolicyExceptRivals
